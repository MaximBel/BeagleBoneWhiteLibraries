...
namespace BlackLib
{
    ...
    */
    enum pwmName            {   GPIO1_18_Clk1                   = 0,
    							GPIO1_19_Clk1                   = 1,
								GPIO0_22_Clk2                   = 2,
								GPIO0_23_Clk2                   = 3,

                                EHRPWM2B                = GPIO0_23_Clk2,
                                EHRPWM2A                = GPIO0_22_Clk2,
                                EHRPWM1A                = GPIO1_18_Clk1,
                                EHRPWM1B                = GPIO1_19_Clk1,

								PwmChannels_Amount 				= 4
    ...
    */
    ...
    class BlackPWM
    {
        private:
            ...
            static const Chip_Channel_List_t Chip_Channel_List[PwmChannels_Amount];
